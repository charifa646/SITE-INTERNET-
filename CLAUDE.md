...
## 0bis. FICHIERS DE RÉFÉRENCE (à lire avant toute action)

- **`COPYWRITING.md`** — source de vérité pour TOUT le texte du site
- **`ASSETS.md`** — inventaire de toutes les images/vidéos et leur emplacement exact
- **`COMPONENTS.md`** — spec d'intégration de chaque composant/animation (où, quels assets, quel texte, quelles adaptations)

Pour toute tâche touchant au contenu, aux images ou aux animations : ouvrir le fichier concerné AVANT d'écrire du code.
