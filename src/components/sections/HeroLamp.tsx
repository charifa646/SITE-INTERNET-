...
export default function HeroLamp() {
  return (
    <section className="relative min-h-[100dvh] bg-[#0A0F1E] overflow-hidden flex flex-col items-center justify-center pb-28 md:pb-40">
      {/* Vidéo fond */}
      <video
        src="/portfolio/video-hero-acceuil.mp4"
        autoPlay
        muted
        loop
        playsInline
      ...
      />
      {/* Overlay radial — fond profond vers les bords */}
      <div
        aria-hidden="true"
        className="absolute inset-0 z-[1]"
        style={{
          background: 'radial-gradient(ellipse 80% 60% at 50% 100%, rgba(10,15,30,0.97) 0%, rgba(10,15,30,0.6) 60%, rgba(10,15,30,0.2) 100%)',
        }}
      />
